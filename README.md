...
```bash
https://github.com/louayamor/KidneyDiseasePrediction
```

### STEP 01- Create a conda environment after opening the repository

```bash
conda KidneyDiseasePrediction -n mlproj python=3.11 -y
```

```bash
conda activate KidneyDiseasePrediction
```
...
export MLFLOW_TRACKING_URI=https://dagshub.com/louayamor/KidneyDiseasePrediction.mlflow

export MLFLOW_TRACKING_USERNAME=louayamor

export MLFLOW_TRACKING_PASSWORD= 99072e0fd2867883dcad2245a0a2f8a758a01137
